...
RangeReading::RangeReading(const RangeSensor* rs, double time):
        SensorReading(rs,time), nonStruct_(false){}

RangeReading::RangeReading(unsigned int n_beams, const double* d, const RangeSensor* rs, double time, bool nonStruct):
        SensorReading(rs,time), nonStruct_(nonStruct){
