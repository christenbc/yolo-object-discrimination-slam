...
void ScanMatcherProcessor::processScan(const RangeReading & reading, bool nonStruct){
...
#endif
                        m_matcher.registerScan(m_map, m_pose, plainReading, nonStruct);
		} else {
                        m_matcher.registerScan(m_map, newPose, plainReading, nonStruct);
#ifdef SCANMATHCERPROCESSOR_DEBUG
